...
coverage: ## check code coverage quickly with the default Python
	coverage run --source ecs_composex_specs -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/ecs_composex_specs.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ ecs_composex_specs
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
conform	: ## Conform to a standard of coding syntax
	black ecs_composex_specs tests setup.py
